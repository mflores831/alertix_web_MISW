...
import { Container, Box, Drawer, List, ListItem, ListItemButton, ListItemText, ListItemIcon, Typography, Select, MenuItem } from "@mui/material";
...
const Feedback = () => {
  ...
  const imageSrc = selectedStat === "totalAlarms" ? "/estadistica_3.png" : "/estadistica_4.png";
        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
          ...
          <Box display="flex" justifyContent="space-between" alignItems="center" sx={{ width: "100%" }}>
            ...
            <Box sx={{ width: 400 }}>
              ...
              >
                <MenuItem value="totalAlarms">% de alarmas completadas sin posponer</MenuItem>
                <MenuItem value="snoozedAlarms">Número de alarmas ignoradas o desactivadas sin completar la tarea</MenuItem>
              </Select>
            </Box>
